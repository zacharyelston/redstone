...
echo "1. Run the test script against your deployment:"
echo "   GRAFANA_URL=https://grafana-redstone-example.local ./scripts/test-grafana-provisioning.sh"
echo ""
echo "2. If ConfigMaps are missing, check deployment logs"
echo ""
